...
<body>
    ...
    const bookingsData = [
      { bookings: <?php echo $today_bookings; ?> },  // Monday
      { bookings: <?php echo $weekly_bookings; ?> },  // Tuesday
      { bookings: <?php echo $total_bookings; ?> },  // Wednesday
      { bookings: <?php echo $total_bookings; ?> },  // Thursday
      { bookings: <?php echo $total_bookings; ?> },  // Friday
      { bookings: <?php echo $total_bookings; ?> },  // Saturday
